...
int main(int argc, char **argv)
{
  ...
  int zipf = 0;
  double zipf_dist_val = 0; 

  while(1) {
    i = 0;
    c = getopt_long(argc, argv, "hd:i:n:r:s:u:z:", long_options, &i);
    ...
    switch(c) {
     ...
     case 'h':
       printf("intset -- STM stress test "
              ...
              "  -z, --zipf_dist_val <double>\n"
              "        Percentage of update transactions (default=" XSTR(DEFAULT_ZIPF_DIST_VAL) ")\n"
         );
       exit(0);
     case 'd':
