...
CMD_BASE_HARRIS = '../src/bench-harris'
CMD_BASE_HP_HARRIS = '../src/bench-hp-harris'
CMD_BASE_RCU = '../src/bench-rcu'
CMD_BASE_RLU = '../src/bench-rlu'
CMD_BASE_RLU_ORDO = '../src/bench-rlu-ordo'
CMD_BASE_MVRLU = '../src/bench-mvrlu'
CMD_BASE_MVRLU_ORDO = '../src/bench-mvrlu-ordo'
...
#	't_sync_and_writeback =',
        ...
        't_writeback_spent      =',
        't_blocking_spent       =',
        't_ckp_quiescence_spent =',
        't_ckp_scan_spent       =', 
        't_ckp_builder_spent    =',
        't_ckp_barrier_spent    =',
        't_max_last_objs        =',
        't_avg_last_objs        =',
        't_ckp_builder_by_wakeup=',
]
