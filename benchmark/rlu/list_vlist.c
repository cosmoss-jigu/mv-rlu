...
#include <stdlib.h>
static volatile struct vlist_record *g_committed_rec = NULL;
...
static void vlist_free_slots_later(vlist_slot_t *slot, vlist_pthread_data_t *vlist_data)
{
...
int list_thread_init(vlist_pthread_data_t *vlist_data, vlist_pthread_data_t **sync_data, int nr_threads)
{
